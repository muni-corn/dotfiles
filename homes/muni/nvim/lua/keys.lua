...
map('n', "<leader>xn", "<cmd>lua vim.lsp.diagnostic.goto_next({ enable_popup = false })<cr>", { noremap = true, silent = true })
map('n', "<leader>xp", "<cmd>lua vim.lsp.diagnostic.goto_prev({ enable_popup = false })<cr>", { noremap = true, silent = true })
...
map('', "<leader>pp", ":!pandoc --citeproc \"%\" -o \"%.pdf\"<cr>", { noremap = true, silent = true})
map('', "<leader>pd", ":!pandoc --citeproc \"%\" -o \"%.docx\"<cr>", { noremap = true, silent = true})
map('', "<leader>pm", ":!pandoc --citeproc \"%\" -o \"%.md\"<cr>", { noremap = true, silent = true})
map('', "<leader>ph", ":!pandoc --citeproc \"%\" -o \"%.html\"<cr>", { noremap = true, silent = true})
