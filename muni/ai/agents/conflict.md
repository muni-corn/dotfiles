...
1. **Context understanding:** Review the commit history, branch purposes, and
   code context to understand why conflicts occurred and what each side of the
   conflict represents.
1. **Resolution strategy:** Determine the most appropriate resolution approach:
...
1. **Code quality assurance:** Ensure resolved code maintains:
...
1. Detailed analysis of each conflict
1. How you resolved each conflict
1. Recommended next steps and Git commands
