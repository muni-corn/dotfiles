...
in {
  programs.nixvim.highlight = {
    ...
    NotifyDEBUGBorder = hl "green" null {};
    NotifyDEBUGIcon = hl "green" null {};
    NotifyDEBUGTitle = hl "green" null {bold = true;};
    NotifyERRORBorder = hl "red" null {};
    NotifyERRORIcon = hl "red" null {};
    NotifyERRORTitle = hl "red" null {bold = true;};
    NotifyINFOBorder = hl "cyan" null {};
    NotifyINFOIcon = hl "cyan" null {};
    NotifyINFOTitle = hl "cyan" null {bold = true;};
    NotifyTRACEBorder = hl "purple" null {};
    NotifyTRACEIcon = hl "purple" null {};
    NotifyTRACETitle = hl "purple" null {bold = true;};
    NotifyWARNBorder = hl "yellow" null {};
    NotifyWARNIcon = hl "yellow" null {};
    NotifyWARNTitle = hl "yellow" null {bold = true;};
