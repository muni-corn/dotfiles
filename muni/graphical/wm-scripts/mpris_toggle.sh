...
# original source: https://github.com/Icelk/dotfiles/blob/1fddc7c1f9120dab66e94273019909825cda8c73/scripts/playerctl-custom.sh
...
# If there was nothing to pause (we would've `exit`ed), play from the preferred editor.
pctl (pref_spt) "Play"
